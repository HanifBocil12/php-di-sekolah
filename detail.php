    ...
    <div class="container p-5">
        <div class="row">
            <div class="col alert alert-primary rounded p-4">
                ...
                ?>
                <form action="update.php?id=<?= $data['id']; ?>" method="post" class="">
                    <div class=" row mb-2">
                        <label class="col-2 form-label" for="nm">name</label>
                        <div class="col-10">
                            <input type="text" readonly class="form-control form-control-plaintext" name="nm"
                                value="<?php echo $data['nm'] ?>">
                        </div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <!-- tgl -->
                    <div class=" row mb-2">
                        <label class="col-2 form-label" for="tgl_lahir">tanggal lahir</label>
                    </div>
                    <div class="col-10">
